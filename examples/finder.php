<?php
    ...
    class SampleForm extends Form
    {
        ...
        /**
         * Handles the click event for the "Cancel" button. This method validates the CSRF token
         * and, if valid, closes the current window. If the CSRF token is invalid, it displays
         * a dialog box and regenerates a new token.
         *
         * @param ActionParams $params An object containing the parameters provided during the
         * click event, typically including context and relevant data.
         *
         * @return void This method does not return a value.
         * @throws Caller
         * @throws RandomException
