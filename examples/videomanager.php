...
class SampleForm5 extends Form
{
    ...
    protected function formCreate(): void
    {
        ...
        $this->objVideoEmbed->UseWrapper = true;
...
//        }
        ...
        $this->objVideoEmbed->addAction(new Q\Plugin\Event\VideoSave(), new Q\Action\Ajax('videoSave_Push'));
        $this->objVideoEmbed->addAction(new Q\Plugin\Event\VideoDelete(), new Q\Action\Ajax('videoDelete_Push'));

        //$this->objVideoEmbed->SelectedVideoId = 1; /*$objExample->getVideoEmbed() ?? null;*/
...
//        $this->objMediaFinder->EmptyImageAlt = t("Choose a video");
//        $this->objMediaFinder->SelectedImageAlt = t("Selected video");
//
...
//        $this->objMediaFinder->addAction(new Q\Plugin\Event\ImageDelete(), new Q\Action\Ajax('imageDelete_Push'));
    ...
    protected function videoSave_Push(ActionParams $params): void
    {
        ...
        $saveId = $this->objVideoEmbed->SaveItem;

        Q\Project\Application::displayAlert('VIDEOSAVE: ' . $saveId);

//        $objExample = Example::load($saveId);
...
//        $this->objVideoEmbed->SelectedVideoEmbed = $objExample->getVideoEmbed() ?? null;
     ...
     * @throws InvalidCast
     */
    protected function videoDelete_Push(ActionParams $params): void
    {

        $deleteId = $this->objVideoEmbed->Item;

        Q\Project\Application::displayAlert('DELETEID: ' . $deleteId);


        $objExample = Example::load($deleteId);

        $objExample->setVideoEmbed(null);
        $objExample->setPictureId(null); // See on ajutine veerg video ID salvestamiseks. Testimise jaoks
        $objExample->save();
